...
setup(
    ...
    download_url = 'https://github.com/owwlo/WebSocketCommandline/tarball/0.0.6',
    ...
    keywords='websocket test server client development',
    ...
    entry_points={
        'console_scripts': [
            'websocket_tester=WebSocketCommandline:main'
        ],
    },
)
